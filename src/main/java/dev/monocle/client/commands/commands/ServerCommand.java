...
public class ServerCommand extends Command {
    ...
    private void onReadPacket(PacketEvent.Receive event) {
        ...
        if (event.packet instanceof ClientboundCommandsPacket packet) {
            ...
            packet.getRoot(
                CommandBuildContext.simple(handler.monocle$getRegistryAccess(), handler.monocle$getEnabledFeatures()),
                ClientPacketListenerAccessor.monocle$getCommandNodeFactory()
