...
import dev.monocle.client.mixin.MapTextureManagerAccessor;
...
public class SaveMapCommand extends Command {
    ...
    private void saveMap(int scale) throws CommandSyntaxException {
        ...
        MapTextureManager.MapInstance texture = textureManager.monocle$invokeGetOrCreateMapInstance(map.get(DataComponents.MAP_ID), state);
        ...
        try {
            ...
            MonocleClient.LOG.error(e.toString());
        }
    }
