...
import dev.monocle.client.events.world.ParticleEvent;
import dev.monocle.client.mixin.BlockEntityRenderStateAccessor;
...
public class NoRender extends Module {
    ...
    private void onRenderBlockEntity(RenderBlockEntityEvent event) {
        if (blockEntities.get().contains(((BlockEntityRenderStateAccessor) event.blockEntityState).monocle$getBlockState().getBlock())) event.cancel();
    }
