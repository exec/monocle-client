...
import dev.monocle.client.mixin.LivingEntityAccessor;
...
public class FastClimb extends Module {
    ...
    private boolean climbing() {
        return (mc.player.horizontalCollision || ((LivingEntityAccessor) mc.player).monocle$isJumping()) && (mc.player.onClimbable() || mc.player.getInBlockState().is(Blocks.POWDER_SNOW) && PowderSnowBlock.canEntityWalkOnPowderSnow(mc.player));
    }
}
