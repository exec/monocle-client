...
import dev.monocle.client.gui.renderer.operations.TextOperation;
import dev.monocle.client.gui.renderer.packer.GuiTexture;
import dev.monocle.client.gui.renderer.packer.TexturePacker;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(MonocleClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(MonocleClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(MonocleClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(MonocleClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(MonocleClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(MonocleClient.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(MonocleClient.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(MonocleClient.identifier("textures/icons/gui/paste.png"));
    ...
    public void triangle(double x1, double y1, double x2, double y2, double x3, double y3, Color c1, Color c2, Color c3) {
        r.triangle(x1, y1, x2, y2, x3, y3, c1, c2, c3);
    }
