...
package dev.monocle.client.utils.render.color;
...
import dev.monocle.client.utils.misc.UnorderedArrayList;
...
public class RainbowColors {
    ...
    public static void init() {
        MonocleClient.EVENT_BUS.subscribe(RainbowColors.class);
    }
