...
import dev.monocle.client.systems.modules.movement.NoFall;
import dev.monocle.client.utils.Utils;
import dev.monocle.client.utils.entity.DamageUtils;
import dev.monocle.client.utils.entity.EntityUtils;
import dev.monocle.client.utils.misc.text.TextUtils;
...
import static dev.monocle.client.utils.Utils.WHITE;
...
public class PlayerUtils {
    ...
    public static Vec3 getHorizontalVelocity(double bps) {
        ...
        ((IVec3) horizontalVelocity).monocle$setXZ(velX, velZ);
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3) vec1).monocle$set(mc.player.getX(), mc.player.getY() + mc.player.getEyeHeight(), mc.player.getZ());
        ((IVec3) vec2).monocle$set(entity.getX(), entity.getY(), entity.getZ());
        ...
        ((IVec3) vec2).monocle$set(entity.getX(), entity.getY() + entity.getEyeHeight(), entity.getZ());
