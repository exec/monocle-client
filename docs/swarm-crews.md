...
5. Stand the host at the normal Highway Builder road center, then run `.swarm highway start 128` (**128 total shared road blocks**), or use **Start shared-width highway crew (host)** with the crew-road-length setting. Limits: 16–100,000 total blocks, 2–3 players including the host, and no more players than floor columns.
